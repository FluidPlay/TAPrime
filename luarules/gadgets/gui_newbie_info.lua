...
function gadget:Initialize()
	...
	keyInfo = gl.CreateList(function()
		...
		curPos = curPos + lineHeight
		gl.Text("Check out the TA Prime docs on \255\200\200\255http://fluidplay.co/taprime\255\255\255\255 for extended gameplay docs", dx+indent, dy-curPos, textSize, "o")
		curPos = curPos + gapSize	
