...
function gadget:GetInfo()
    return {
        name      = "Tech Booster Level 2",
        desc      = "Speeds up all Morphs by 25%",
        author    = "MaDDoX",
...
if gadgetHandler:IsSyncedCode() then
    ...
    local techProxycmdID = -UnitDefNames["techbooster2"].id  -- This is the proxy unit's build CmdID
