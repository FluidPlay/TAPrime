...
--NUKE EXPLOSIONS WITH DAMAGE--
    ...
    commanderexplosion = {
		...
		range = 320, --380,
        weaponvelocity = 1000, --250,
		craterboost = 6,
		cratermult = 3,
        edgeeffectiveness = 1, --0.167,
		reloadtime = 3.5999999046326,
		turret = 1,
		damage = {
			default = 50000,
    ...
    commanderexplosion2 = {
        name = "Matter/AntimatterExplosionLvl2",
        weaponType = "Cannon",
        AreaOfEffect = 360,
        cameraShake = 720,
        impulseboost = 3,
    ...
    commanderexplosion3 = {
        name = "Matter/AntimatterExplosionLvl3",
        weaponType = "Cannon",
        AreaOfEffect = 450,
        cameraShake = 720,
        impulseboost = 3,
    ...
    commanderexplosion4 = {
        name = "Matter/AntimatterExplosionLvl4",
        weaponType = "Cannon",
        AreaOfEffect = 720,
        cameraShake = 720,
        impulseboost = 3,
    ...
    commanderexplosionemp = {
        name = "Matter/AntimatterExplosionEMP",
        weaponType = "Cannon",
        AreaOfEffect = 720,
        soundhit = "EMGPULS1",
        explosiongenerator = "custom:genericshellexplosion-huge-lightning",
