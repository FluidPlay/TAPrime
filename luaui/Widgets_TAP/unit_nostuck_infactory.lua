function widget:GetInfo()
  return {
    ...
    desc      = "Always move unit away from factory's build yard & Remove an accidental build-unit command given to
                 unit in factory. This prevent the case of unit stuck in factory & to make sure unit can complete
                 their move queue.",
    author    = "msafwan",
    date      = "2 January 2014",
    license   = "none",
