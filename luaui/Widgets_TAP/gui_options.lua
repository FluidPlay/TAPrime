...
function init()
	...
	options = {
		...
		{id="nanoeffect", group="gfx", name="Nano effect", type="select", options={'beam','particles'}, value=tonumber(Spring.GetConfigInt("NanoEffect",0) or 0), description='Sets nano effect\n\nBeams more expensive than particles'},
