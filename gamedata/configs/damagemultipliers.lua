...
local damageMultipliers = {
	...
	bullet={ 	lightbot = 1.08, supportbot = 2.5,	heavybot = 0.8, lightveh = 0.3,     supportveh = 0.5,   heavyveh = 0.5,
				lightair = 0.44, supportair = 0.65,	heavyair = 1.5, lightship = 0.75,   supportship = 1,    heavyship = 0.25,
                structure = 0.75,resource = 0.25, 	defense = 0.18, defenseaa = 0.25,   commander = 0.3,
	}
,
    laser={     lightbot = 1.25,supportbot = 2,     heavybot = 0.9, lightveh = 0.72,    supportveh = 0.5,   heavyveh = 0.42,
                lightair = 1.25,supportair = 0.5,   heavyair = 1,   lightship = 1.25,   supportship = 2,    heavyship = 0.5,
                structure = 1.1,resource = 0.5,     defense = 0.7,  defenseaa = 0.25,   commander = 0.3,
    }
,
...
,
	homing={ 	lightbot = 1,   supportbot = 0.25, 	heavybot = 0.3, lightveh = 0.75,    supportveh = 1.25,  heavyveh = 4.65, --3.2,
				lightair = 0.9, supportair = 2, 	heavyair = 2.5, lightship = 1.25,   supportship = 1.75, heavyship = 2.5,
...
,
	cannon={ 	lightbot = 0.2, supportbot = 0.25,  heavybot = 0.675,lightveh = 1.6, 	supportveh = 1.5,     heavyveh = 1,
...
,
	thermo={ 	lightbot = 0.5, supportbot = 1.1, 	heavybot = 1.5, lightveh = 0.22,    supportveh = 1.25,      heavyveh = 1.4,
...
,
	flak={ 		lightbot = 0.5, supportbot = 0.9, 	heavybot = 1.33,lightveh = 0.35,    supportveh = 0.75,  heavyveh = 0.275,
...
,
	neutron={ 	lightbot = 0.3, supportbot = 1, 	heavybot = 0.25,lightveh = 0.75,    supportveh = 0.4, 	heavyveh = 3.5,
