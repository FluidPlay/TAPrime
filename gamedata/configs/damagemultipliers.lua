...
,
	laser={ 	lightbot = 1.8,	supportbot = 1.6,heavybot = 0.7, lightveh = 0.6, 	supportveh = 0.65,      heavyveh = 0.33,
...
,
    plasma={ 	lightbot = 1.05,supportbot = 0.45, heavybot = 1,    lightveh = 0.8,    supportveh = 0.65,      heavyveh = 0.8,
                lightair = 0.75,supportair = 1.25, heavyair = 1.5,  lightship = 1.75,supportship = 1,   heavyship = 1.5,
...
,
	thermo={ 	lightbot = 0.4, supportbot = 1.1, 	heavybot = 0.85, lightveh = 0.3,supportveh = 1.25,      heavyveh = 1.2,
                lightair = 1.3, supportair = 1.5,	heavyair = 1.25, lightship = 2,  supportship = 0.5,heavyship = 1.75,
...
,
	flak={ 		lightbot = 0.75,supportbot = 0.3, 	heavybot = 1.25,lightveh = 0.75,supportveh = 0.75,  heavyveh = 0.275,
				lightair = 1, 	supportair = 0.75, heavyair = 0.3,  lightship = 0.33,supportship = 0.45,heavyship = 0.75,
