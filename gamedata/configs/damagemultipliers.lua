...
,
	thermo={ 	lightbot = 0.4, supportbot = 1.1, 	heavybot = 1.5, lightveh = 0.3,    supportveh = 1.25,      heavyveh = 1.4,
...
,
	flak={ 		lightbot = 0.75,supportbot = 0.5, 	heavybot = 1.25,lightveh = 0.75,    supportveh = 0.75,  heavyveh = 0.275,
