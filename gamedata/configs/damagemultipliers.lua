...
local damageMultipliers = {
	...
	bullet={ 	lightbot = 1.1,	supportbot = 2.5,	heavybot = 0.8, lightveh = 0.25,    supportveh = 0.5,   heavyveh = 0.5,
...
,
    laser={     lightbot = 1.5, supportbot = 2.22,   heavybot = 0.9, lightveh = 0.6,     supportveh = 0.65,  heavyveh = 0.42,
...
,
	rocket={ 	lightbot = 0.22,supportbot = 0.35,  heavybot = 0.35,lightveh = 0.65,    supportveh = 0.85,	heavyveh = 4,
...
,
    plasma={ 	lightbot = 1.0, supportbot = 0.75,  heavybot = 0.6, lightveh = 0.9,     supportveh = 0.45,  heavyveh = 0.4,
                lightair = 0.75,supportair = 1.25,  heavyair = 1.5, lightship = 1.75,   supportship = 0.75, heavyship = 1.5,
                structure = 1,  resource = 1, 		defense = 0.275,defenseaa = 0.6,    commander = 1.27,
	}
,
	cannon={ 	lightbot = 0.5, supportbot = 0.25,  heavybot = 0.75,lightveh = 1.6, 	supportveh = 2,        heavyveh = 1,
...
,
	thermo={ 	lightbot = 0.4, supportbot = 1.1, 	heavybot = 1.6, lightveh = 0.22,    supportveh = 1.25,      heavyveh = 1.4,
...
,
	explosive={ lightbot = 1.2, supportbot = 0.65,  heavybot = 0.85, lightveh = 1.1,     supportveh = 0.65,  heavyveh = 1.25,
