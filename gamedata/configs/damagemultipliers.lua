...
local damageMultipliers = {
	...
	bullet={ 	lightbot = 1.3,	supportbot = 2.5,	heavybot = 0.8, lightveh = 0.3,     supportveh = 0.5,   heavyveh = 0.5,
				lightair = 0.7,	supportair = 1,	    heavyair = 1.5, lightship = 0.75,   supportship = 1,    heavyship = 0.25,
                structure = 0.75,resource = 0.25, 	defense = 0.18, defenseaa = 0.25,   commander = 0.3,
	}
,
    laser={     lightbot = 1.5, supportbot = 2.5,   heavybot = 0.9, lightveh = 0.72,    supportveh = 0.65,  heavyveh = 0.42,
                lightair = 1.25,supportair = 0.75,  heavyair = 1,   lightship = 1.25,   supportship = 2,    heavyship = 0.5,
...
,
	hflaser={   lightbot = 1.5,  supportbot = 1.2,	heavybot = 0.45,lightveh = 0.55,    supportveh = 0.3,   heavyveh = 0.65,
...
,
    plasma={ 	lightbot = 1.2, supportbot = 0.75,  heavybot = 0.6, lightveh = 0.9,     supportveh = 0.45,  heavyveh = 0.4,
...
,
	cannon={ 	lightbot = 0.2, supportbot = 0.25,  heavybot = 0.75,lightveh = 1.6, 	supportveh = 2,        heavyveh = 1,
...
,
	thermo={ 	lightbot = 0.5, supportbot = 1.1, 	heavybot = 1.6, lightveh = 0.22,    supportveh = 1.25,      heavyveh = 1.4,
                lightair = 1.3, supportair = 2.5,	heavyair = 1,   lightship = 2,      supportship = 0.5,     heavyship = 1.75,
                structure = 0.75,resource = 0.45, 	defense = 0.25, defenseaa = 0.5,    commander = 0.25,
	}
,
...
,
	explosive={ lightbot = 1.2, supportbot = 1,     heavybot = 0.85,lightveh = 1.1,     supportveh = 0.65,  heavyveh = 1.25,
