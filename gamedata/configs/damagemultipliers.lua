...
local damageMultipliers = {
	...
	bullet={ 	lightbot = 1,	supportbot = 1.8,	heavybot = 0.55,lightveh = 0.25,    supportveh = 0.5,   heavyveh = 0.3,
...
,
	rocket={ 	lightbot = 0.22,supportbot = 0.5,   heavybot = 0.35,lightveh = 0.4,     supportveh = 0.85,	heavyveh = 4,
...
,
    plasma={ 	lightbot = 1.05,supportbot = 0.75, heavybot = 0.3,  lightveh = 0.8,     supportveh = 0.45,  heavyveh = 0.5,
...
,
	cannon={ 	lightbot = 0.5, supportbot = 0.25, heavybot = 0.4,lightveh = 2, 	    supportveh = 2,        heavyveh = 1,
...
,
	thermo={ 	lightbot = 0.4, supportbot = 1.1, 	heavybot = 1.8, lightveh = 0.3,    supportveh = 1.25,      heavyveh = 1.4,
...
,
	flak={ 		lightbot = 0.5, supportbot = 0.65, 	heavybot = 1.2, lightveh = 0.45,    supportveh = 0.75,  heavyveh = 0.275,
...
,
	rail={ 		lightbot = 1,	supportbot = 1.4,	heavybot = 0.6,	lightveh = 0.2,     supportveh = 0.35,heavyveh = 1.2,
