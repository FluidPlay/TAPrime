...
local damageMultipliers = {
	...
	bullet={ 	lightbot = 1.1,	supportbot = 2.5,	heavybot = 0.8, lightveh = 0.3,     supportveh = 0.5,   heavyveh = 0.5,
...
,
    laser={     lightbot = 1.3, supportbot = 2.5,   heavybot = 0.9, lightveh = 0.72,    supportveh = 0.65,  heavyveh = 0.42,
