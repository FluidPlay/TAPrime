...
local tips = {
    ...
    "corlevlr.dds ".."The Core Leveler, besides having a weapon with good splash, is able to transport up to two light kbots - including builders. Hint: even allied builders can be transported.",
    "armfav.dds ".."Arm Pokers and Core Levelers are excellent at running over rifle kbots (A.K., Peewee), but are not heavy enough to crush missile or plasma kbots. Keep this in mind if your opponent decides to spam those cheaper units like there's no tomorrow - then make sure he's right. ;)",
